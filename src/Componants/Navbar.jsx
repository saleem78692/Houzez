...
const menuData = {
  home: {
    ...
    links: [
      { to: "/", label: "Default" },
      { to: "/caption-form", label: "With Caption Form" },
      { to: "/overlay-search", label: "With Overlay Side Search" },
      { to: "/map", label: "With Map" },
      { to: "/image-banner", label: "With Image Banner" },
      { to: "/property-slider", label: "With Properties Slider" },
      { to: "/revolution-slider", label: "With Revolution Slider" },
      { to: "/video", label: "With Video" },
      { to: "/advanced-search", label: "Overlay Advanced Search" },
    ],
  },
  properties: {
    label: "PROPERTIES",
...
function Navbar() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://demo01.houzez.co/wp-content/uploads/2016/03/miami-beach.jpg')",
      }}
    >
        ...
        >
          ...
          <ul style={{ listStyle: "none", margin: 0, padding: "8px 0", flex: 1 }}>
            {Object.entries(menuData).map(([key, menu]) => (
              <li key={key} style={{ borderBottom: "0.5px solid rgba(255,255,255,0.05)" }}>
                <button
