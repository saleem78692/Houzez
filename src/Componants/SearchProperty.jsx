    ...
    <>
      <div className="w-full px-4 py-1 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-visible">
          ...
          <div className="flex p-3 align-middle justify-center">
            {tabs.map((tab) => (
              <button
                key={tab.key}
          ...
          <div className="px-6 pb-6 pt-5 rounded-b-2xl rounded-tr-2xl bg-white">
            ...
            <div className="flex flex-wrap xl:flex-nowrap gap-3 items-end">
              ...
              <div className="w-full xl:w-auto flex-shrink-0">
                <button onClick={IsSearch} disabled={isSearching} className="w-full xl:w-auto px-8 py-3 bg-sky-500 hover:bg-sky-600 active:scale-95 text-white text-sm font-bold tracking-widest uppercase rounded-lg transition-all duration-200 shadow-lg shadow-sky-400/40 hover:shadow-sky-500/50 flex items-center justify-center gap-2 whitespace-nowrap">
                  {isSearching ? (
